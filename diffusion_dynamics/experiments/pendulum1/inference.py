...
if __name__ == "__main__":
    ...
    pendulum_model = PendulumModel().load_trained_model(os.path.join(saved_model_params["save_fpath"], saved_model_params["save_model_name"]))
    ...
    ax[0].legend(handles=[
        Line2D([0], [0], marker='o', color='w', markerfacecolor='red', markersize=10, label=r"$\theta$"),
        Line2D([0], [0], marker='o', color='w', markerfacecolor='blue', markersize=10, label=r"$\dot{\theta}$"),
    ], loc="upper right")
