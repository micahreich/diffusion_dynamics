...
system = Pendulum(PendulumParams(m=1, l=1, b=1.0))
...
us_brownian_motion_tensor = generate_brownian_motion_paths(
    N_training_trajectories,
    seq_len,
    dt,
    u0_range=(-6, 6),
    dB_scale=3.0,
...
if __name__ == "__main__":
    ...
    system.set_history(
        torch.arange(0, seq_len * dt, dt),
        training_data[0, : system.nx, :].T,
        training_data[0, system.nx :, :].T,
    )
